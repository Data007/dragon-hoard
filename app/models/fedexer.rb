    ...
    def recipient name, address, phone_number
      {
        ...
        country_code: get_country(address.country),
        residential: 'false'
      }
    end
